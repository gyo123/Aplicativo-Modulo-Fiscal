...
import com.example.modulofiscal.databinding.ActivitySimplesnacionalBinding

class simplesnacional : AppCompatActivity() {


    private lateinit var binding: ActivitySimplesnacionalBinding

    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        binding = ActivitySimplesnacionalBinding.inflate(layoutInflater)
